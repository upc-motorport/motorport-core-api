...
namespace Motorport.Infrastructure.Migrations
{
    ...
    [Migration("20191116024033_MembershipRoleConversion")]
    partial class MembershipRoleConversion
    {
            ...
            modelBuilder.Entity("Motorport.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2019, 11, 15, 21, 40, 32, 801, DateTimeKind.Local).AddTicks(5357),
                            Email = "alvarado.manuel@live.com",
                            ModifiedAt = new DateTime(2019, 11, 15, 21, 40, 32, 801, DateTimeKind.Local).AddTicks(5370),
                            Password = "$2b$10$P6SwjIhsPbAXvcdtCNX9PeOlCpy9SvCk/TyPXQ0EumsFUd3PiCkku"
                        });
                });
            ...
            modelBuilder.Entity("Motorport.Domain.Models.Vehicle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Brand = "Chevrolet",
                            CreatedAt = new DateTime(2019, 11, 15, 21, 40, 32, 654, DateTimeKind.Local).AddTicks(6239),
                            Kilometers = 0,
                            Model = "Camaro",
                            ModifiedAt = new DateTime(2019, 11, 15, 21, 40, 32, 655, DateTimeKind.Local).AddTicks(7004),
                        ...
                        new
                        {
                            ...
                            Active = true,
                            Brand = "Chevrolet",
                            CreatedAt = new DateTime(2019, 11, 15, 21, 40, 32, 656, DateTimeKind.Local).AddTicks(1044),
                            Kilometers = 0,
                            Model = "Bolt",
                            ModifiedAt = new DateTime(2019, 11, 15, 21, 40, 32, 656, DateTimeKind.Local).AddTicks(1055),
